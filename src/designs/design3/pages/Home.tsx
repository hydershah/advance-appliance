    ...
    <div className="min-h-screen bg-contemporary-platinum-200">
      ...
      <section ref={heroRef} className="relative min-h-[85vh] flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0">
          ...
          <div className="absolute inset-0 bg-contemporary-charcoal-900/60" />
          <div className="absolute inset-0 bg-gradient-to-b from-contemporary-charcoal-900/40 via-transparent to-contemporary-charcoal-900/60" />
        </div>
        ...
        <div className={`relative z-10 text-center px-4 max-w-4xl mx-auto transform transition-all duration-1000 ${heroVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          <p className="text-contemporary-gold-500 font-montserrat tracking-widest uppercase mb-4 text-sm sm:text-base">Established 1992 | 30+ Years of Excellence</p>
          <h1 className="font-playfair font-bold text-4xl sm:text-5xl md:text-6xl lg:text-7xl text-contemporary-white mb-6 leading-tight">
            Advanced Appliance<span className="block text-contemporary-gold-500">Repair Service</span>
          </h1>
          <p className="font-poppins text-contemporary-white/90 text-lg sm:text-xl max-w-2xl mx-auto mb-8 leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button variant="outline" size="lg" href="tel:7324167430" className="border-contemporary-white text-contemporary-white hover:bg-contemporary-white hover:text-contemporary-charcoal-900">
          ...
          <div className="flex flex-wrap justify-center gap-4 mt-10">
            {['Licensed', 'Bonded', 'Insured', 'Factory Authorized'].map((badge) => (
              <span key={badge} className="px-4 py-2 bg-contemporary-white/10 border border-contemporary-gold-500/50 rounded-full text-contemporary-white/90 font-poppins text-sm backdrop-blur-sm">{badge}</span>
            ))}
          </div>
        </div>
      </section>
      ...
      {/* Our Promise Section */}
      <section ref={promiseRef} className="py-20 bg-contemporary-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className={`text-center mb-16 transform transition-all duration-700 ${promiseVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            <p className="text-contemporary-slate-900 font-montserrat tracking-widest uppercase mb-4">Why Choose Us</p>
            <h2 className="font-playfair font-bold text-4xl sm:text-5xl text-contemporary-charcoal-900 mb-6">Our Promise to You</h2>
          ...
          <div className={`grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 transform transition-all duration-700 delay-200 ${promiseVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            {[
              ...
              <div key={item.title} className="text-center p-6 bg-contemporary-white border border-contemporary-platinum-400/30 rounded-xl hover:border-contemporary-gold-500 hover:shadow-lg transition-all duration-300 group" style={{ transitionDelay: `${index * 100}ms` }}>
                <div className="w-16 h-16 mx-auto mb-6 rounded-full bg-contemporary-charcoal-900/10 flex items-center justify-center text-contemporary-charcoal-900 group-hover:bg-contemporary-gold-500 group-hover:text-contemporary-white transition-all duration-300">{item.icon}</div>
                <h3 className="font-playfair font-bold text-xl text-contemporary-charcoal-900 mb-3">{item.title}</h3>
                <p className="font-poppins text-contemporary-charcoal-900/70 leading-relaxed">{item.description}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section ref={servicesRef} className="py-20 bg-contemporary-platinum-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className={`text-center mb-16 transform transition-all duration-700 ${servicesVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            <p className="text-contemporary-slate-900 font-montserrat tracking-widest uppercase mb-4">What We Do</p>
            <h2 className="font-playfair font-bold text-4xl sm:text-5xl text-contemporary-charcoal-900 mb-6">Our Premium Services</h2>
            <OrnamentDivider variant="diamond" color="contemporary-charcoal-900" className="max-w-md mx-auto" />
            <p className="font-poppins text-contemporary-charcoal-900/70 max-w-2xl mx-auto mt-6 text-lg">From everyday appliances to luxury brands, we provide expert repair services with the care and attention your home deserves.</p>
          </div>
      ...
      <section ref={testimonialsRef} className="py-20 bg-contemporary-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className={`text-center mb-16 transform transition-all duration-700 ${testimonialsVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            <p className="text-contemporary-slate-900 font-montserrat tracking-widest uppercase mb-4">Testimonials</p>
            <h2 className="font-playfair font-bold text-4xl sm:text-5xl text-contemporary-charcoal-900 mb-6">Stories from Our Clients</h2>
      ...
      {/* Awards Section */}
      <section ref={awardsRef} className="py-20 bg-contemporary-charcoal-900 text-contemporary-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className={`text-center mb-16 transform transition-all duration-700 ${awardsVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            ...
            <h2 className="font-playfair font-bold text-4xl sm:text-5xl text-contemporary-white mb-6">Awards & Certifications</h2>
            <OrnamentDivider variant="ornate" color="contemporary-gold-500" className="max-w-md mx-auto" />
          </div>
          <div className={`grid grid-cols-2 md:grid-cols-4 gap-8 transform transition-all duration-700 delay-200 ${awardsVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            {awards.map((award) => (
              <div key={award.id} className="text-center">
                <div className="w-20 h-20 mx-auto mb-4 rounded-full bg-contemporary-gold-500/20 flex items-center justify-center border-2 border-contemporary-gold-500">
                  <svg className="w-10 h-10 text-contemporary-gold-500" fill="currentColor" viewBox="0 0 20 20"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" /></svg>
                </div>
                <h4 className="font-playfair font-bold text-lg text-contemporary-white mb-1">{award.title}</h4>
                <p className="font-poppins text-contemporary-platinum-400 text-sm">{award.issuer}</p>
                <p className="font-poppins text-contemporary-gold-500 text-sm mt-1">{award.year}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section ref={areasRef} className="py-20 bg-contemporary-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className={`text-center mb-16 transform transition-all duration-700 ${areasVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            <p className="text-contemporary-slate-900 font-montserrat tracking-widest uppercase mb-4">Service Areas</p>
            <h2 className="font-playfair font-bold text-4xl sm:text-5xl text-contemporary-charcoal-900 mb-6">Areas We Serve</h2>
            <OrnamentDivider variant="simple" color="contemporary-charcoal-900" className="max-w-md mx-auto" />
          </div>
          <div className={`grid grid-cols-1 lg:grid-cols-2 gap-12 items-center transform transition-all duration-700 delay-200 ${areasVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            <div className="relative aspect-[4/3] bg-contemporary-charcoal-900/5 rounded-xl border border-contemporary-platinum-400/30 overflow-hidden">
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="text-center p-8">
                  <svg className="w-16 h-16 mx-auto text-contemporary-charcoal-900/40 mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 20l-5.447-2.724A1 1 0 013 16.382V5.618a1 1 0 011.447-.894L9 7m0 13l6-3m-6 3V7m6 10l4.553 2.276A1 1 0 0021 18.382V7.618a1 1 0 00-.553-.894L15 4m0 13V4m0 0L9 7" /></svg>
            ...
            <div>
              <h3 className="font-playfair font-bold text-2xl text-contemporary-charcoal-900 mb-6">Proudly Serving New Jersey</h3>
              <p className="font-poppins text-contemporary-charcoal-900/70 mb-8 leading-relaxed">Our expert technicians provide reliable appliance repair services throughout Central New Jersey.</p>
              <div className="grid grid-cols-2 gap-4">
                {serviceAreas.map((area) => (
                  <a key={area} href={`/areas/${area.toLowerCase().replace(/\s+/g, '-')}`} className="flex items-center p-4 bg-contemporary-charcoal-900/5 rounded-lg border border-contemporary-platinum-400/30 hover:border-contemporary-gold-500 hover:shadow-md transition-all group">
                    <svg className="w-5 h-5 text-contemporary-gold-500 mr-3" fill="currentColor" viewBox="0 0 20 20"><path fillRule="evenodd" d="M5.05 4.05a7 7 0 119.9 9.9L10 18.9l-4.95-4.95a7 7 0 010-9.9zM10 11a2 2 0 100-4 2 2 0 000 4z" clipRule="evenodd" /></svg>
                    <span className="font-poppins text-contemporary-charcoal-900 group-hover:text-contemporary-gold-500 transition-colors">{area}</span>
                  </a>
                ))}
              </div>
      ...
      {/* CTA Section */}
      <section className="py-20 bg-contemporary-slate-900 text-contemporary-white relative overflow-hidden">
        <div className="absolute inset-0 opacity-10">
          <div className="absolute top-0 left-0 w-64 h-64 border-2 border-contemporary-white rounded-full -translate-x-1/2 -translate-y-1/2" />
          <div className="absolute bottom-0 right-0 w-96 h-96 border-2 border-contemporary-white rounded-full translate-x-1/3 translate-y-1/3" />
        </div>
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          <p className="font-poppins text-contemporary-platinum-400 text-lg mb-8 max-w-2xl mx-auto">Our experienced technicians are standing by to help. Contact us today for fast, reliable appliance repair service.</p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button size="lg" className="bg-contemporary-white text-contemporary-slate-900 hover:bg-transparent hover:text-contemporary-white border-contemporary-white" href="/contact">Schedule Service Online</Button>
            <Button variant="outline" size="lg" className="border-contemporary-white text-contemporary-white hover:bg-contemporary-white hover:text-contemporary-slate-900" href="tel:7324167430">
              <svg className="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 20 20"><path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z" /></svg>
              (732) 416-7430
            </Button>
          </div>
