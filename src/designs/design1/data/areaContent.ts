...
export const areaEnrichment: Record<string, AreaEnrichment> = {
  'appliance-repair-in-aberdeen-nj': {
    ...
    nearbyAreaSlugs: ['appliance-repair-in-matawan-nj', 'appliance-repair-in-hazlet-nj', 'appliance-repair-in-keyport-nj'],
  },
  'appliance-repair-belford-nj': {
    slug: 'appliance-repair-belford-nj',
    areaType: 'shore',
    intro: 'Belford is a tight-knit bayfront section of Middletown Township where salt air, summer humidity, and full-time commuter households put real wear on laundry pairs and refrigeration. We service every street from Port Monmouth Road down to the SeaStreak ferry terminal.',
    localNote: 'Homes near the harbor see accelerated compressor and condenser-coil corrosion — we carry OEM sealed-system parts for coastal service days.',
    neighborhoods: ['Belford Harbor', 'Port Monmouth Road', 'Main Street Belford', 'East Keansburg border'],
    landmarks: ['Belford SeaStreak Ferry Terminal', 'Belford Seafood Co-op', 'Henry Hudson Trail'],
    nearbyAreaSlugs: ['appliance-repair-in-port-monmouth-nj', 'appliance-repair-in-leonardo-nj', 'appliance-repair-in-keansburg-nj'],
  },
  ...
  'appliance-repair-in-deal-nj': {
    slug: 'appliance-repair-in-deal-nj',
    areaType: 'luxury',
    intro: 'Deal is one of the Jersey Shore\'s oldest affluent summer colonies, with historic estates, year-round residences, and high-end kitchens that often run Thermador, Wolf, Sub-Zero, and La Cornue. We schedule Deal service calls tight — ocean-block homes need same-week attention before guests arrive.',
    localNote: 'Humidity and salt intrusion here are relentless; we routinely replace ice-maker control boards and range-hood blower motors from corrosion we would never see inland.',
    neighborhoods: ['Deal Lake', 'Ocean Avenue', 'Roseld Avenue', 'Norwood Avenue'],
    landmarks: ['Deal Casino Beach Club', 'Phillips Avenue Beach', 'Conover Pavilion'],
    nearbyAreaSlugs: ['appliance-repair-in-ocean-nj', 'appliance-repair-in-west-long-branch-nj', 'appliance-repair-in-oceanport-nj'],
  },
  'appliance-repair-eatontown-nj': {
    ...
    nearbyAreaSlugs: ['appliance-repair-in-oceanport-nj', 'appliance-repair-in-tinton-falls-nj', 'appliance-repair-in-ocean-nj'],
  },
  ...
  'appliance-repair-in-englishtown-nj': {
    slug: 'appliance-repair-in-englishtown-nj',
    areaType: 'suburban',
    intro: 'Englishtown and the surrounding Manalapan-Englishtown corridor is a mix of older downtown homes and newer planned developments off Tennent Road and Gravel Hill. We serve both — restoring 1980s Maytag laundry pairs one day, diagnosing smart-connected Samsung stacks the next.',
  ...
  'appliance-repair-in-farmingdale-nj': {
    slug: 'appliance-repair-in-farmingdale-nj',
    areaType: 'rural',
    intro: 'Farmingdale sits in southern Monmouth County where lot sizes grow, well water is common, and laundry rooms often run extended-capacity Whirlpool and Speed Queen pairs. We are comfortable with the realities of well-water appliances — scale, sediment, and the valve failures that come with them.',
    localNote: 'We recommend and service whole-home sediment filtration to protect refrigerator ice makers and dishwasher inlet valves in the 07727 zip.',
    neighborhoods: ['Farmingdale Borough', 'Howell border', 'Squankum'],
    landmarks: ['Allaire State Park', 'Allaire Airport', 'Historic Allaire Village'],
    nearbyAreaSlugs: ['appliance-repair-in-neptune-nj', 'appliance-repair-in-tinton-falls-nj', 'appliance-repair-in-freehold-nj'],
  },
  'appliance-repair-in-freehold-nj': {
    ...
    nearbyAreaSlugs: ['appliance-repair-in-manalapan-nj', 'appliance-repair-marlboro-nj', 'appliance-repair-in-englishtown-nj'],
  },
  'appliance-repair-in-hazlet-nj': {
    ...
    nearbyAreaSlugs: ['appliance-repair-in-keansburg-nj', 'appliance-repair-in-keyport-nj', 'appliance-repair-in-matawan-nj'],
  },
  ...
  'appliance-repair-in-keansburg-nj': {
    slug: 'appliance-repair-in-keansburg-nj',
    areaType: 'shore',
    intro: 'Keansburg is a bayfront borough with bungalows, year-round homes, and seasonal rentals close enough to the boardwalk that salt and humidity dictate appliance life. We service laundry pairs, refrigerators, and ranges all along Carr Avenue, Main Street, and the beachfront blocks.',
    localNote: 'Summer rental turnovers create emergency weekend calls — we triage Keansburg same-day whenever rental schedules depend on it.',
    neighborhoods: ['Main Street', 'Carr Avenue', 'Beachway', 'Port Monmouth Road'],
    landmarks: ['Keansburg Amusement Park', 'Runaway Rapids Waterpark', 'Keansburg Fishing Pier'],
    nearbyAreaSlugs: ['appliance-repair-in-port-monmouth-nj', 'appliance-repair-belford-nj', 'appliance-repair-in-hazlet-nj'],
  },
  'appliance-repair-in-keyport-nj': {
    slug: 'appliance-repair-in-keyport-nj',
    areaType: 'historic',
    intro: 'Keyport is a historic waterfront borough — Victorian homes, a walkable Front Street, and a working harbor. Many Keyport kitchens are inside protected historic footprints, so we plan installs carefully around flooring, trim, and doorway clearances that were built before modern appliance dimensions existed.',
    localNote: 'We measure twice for Keyport refrigerator swaps; original kitchen doorways frequently will not accept today\'s 36-inch counter-depth units without a door pull first.',
    neighborhoods: ['Front Street', 'Broad Street', 'West Keyport', 'Keyport Harbor'],
    landmarks: ['Keyport Waterfront Park', 'Keyport Fishery', 'American Legion Park'],
    nearbyAreaSlugs: ['appliance-repair-in-matawan-nj', 'appliance-repair-in-hazlet-nj', 'appliance-repair-in-aberdeen-nj'],
  },
  'appliance-repair-in-leonardo-nj': {
    slug: 'appliance-repair-in-leonardo-nj',
    areaType: 'shore',
    intro: 'Leonardo is a section of Middletown Township anchored by the Henry Hudson Trail and Earle Naval Weapons Station. Bayfront homes, commuter households, and military families keep our Leonardo calendar steady, and we know the older split-level laundry closets that dominate the neighborhood.',
    localNote: 'Dryer vent runs in Leonardo split-levels are frequently too long and too clogged; we inspect and clean vents as part of every dryer diagnostic here.',
    neighborhoods: ['Leonardo', 'Water Witch', 'Navesink Avenue', 'Bray Avenue'],
    landmarks: ['Leonardo State Marina', 'Naval Weapons Station Earle', 'Henry Hudson Trail'],
    nearbyAreaSlugs: ['appliance-repair-belford-nj', 'appliance-repair-in-middletown-nj', 'appliance-repair-in-port-monmouth-nj'],
  },
  ...
  'appliance-repair-in-manalapan-nj': {
    ...
    nearbyAreaSlugs: ['appliance-repair-in-englishtown-nj', 'appliance-repair-marlboro-nj', 'appliance-repair-in-freehold-nj'],
  },
  'appliance-repair-marlboro-nj': {
    ...
    nearbyAreaSlugs: ['appliance-repair-in-manalapan-nj', 'appliance-repair-in-englishtown-nj', 'appliance-repair-in-old-bridge-nj'],
  },
  'appliance-repair-in-matawan-nj': {
    ...
    nearbyAreaSlugs: ['appliance-repair-in-aberdeen-nj', 'appliance-repair-in-keyport-nj', 'appliance-repair-in-old-bridge-nj'],
  },
  ...
  'appliance-repair-in-neptune-nj': {
    ...
    nearbyAreaSlugs: ['appliance-repair-in-ocean-nj', 'appliance-repair-in-tinton-falls-nj', 'appliance-repair-in-west-long-branch-nj'],
  },
  'appliance-repair-in-ocean-nj': {
    ...
    nearbyAreaSlugs: ['appliance-repair-in-deal-nj', 'appliance-repair-in-neptune-nj', 'appliance-repair-in-west-long-branch-nj'],
  },
  'appliance-repair-in-oceanport-nj': {
    slug: 'appliance-repair-in-oceanport-nj',
    areaType: 'shore',
    intro: 'Oceanport wraps around Monmouth Park Racetrack and the eastern edge of the former Fort Monmouth, and its housing mix reflects both — older military-era homes, waterfront properties on the Shrewsbury River, and newer developments. We service every one of them.',
    localNote: 'Waterfront Oceanport homes routinely need ice-maker and dispenser-line replacement; well and brackish-water chemistry here is tough on inlet valves.',
    neighborhoods: ['Oceanport Borough', 'Port-Au-Peck', 'Pleasure Bay'],
    landmarks: ['Monmouth Park Racetrack', 'Oceanport Creek', 'Fort Monmouth Oceanport Gate'],
    nearbyAreaSlugs: ['appliance-repair-eatontown-nj', 'appliance-repair-in-west-long-branch-nj', 'appliance-repair-in-little-silver-nj'],
  },
  ...
  'appliance-repair-in-parlin-nj': {
    slug: 'appliance-repair-in-parlin-nj',
    areaType: 'suburban',
    intro: 'Parlin is a section of Sayreville in eastern Middlesex County — dense single-family housing, a compact commercial strip on Washington Road, and a working-class residential character. Most Parlin homes run mainstream brands (Whirlpool, GE, LG, Samsung) and we carry those parts every day.',
    localNote: 'Multi-unit and two-family homes in Parlin are common; we are comfortable working through landlord-tenant coordination for appliance access and billing.',
    neighborhoods: ['Parlin', 'Old Bridge Turnpike corridor', 'Ernston'],
    landmarks: ['Washington Road', 'Kennedy Park', 'Raritan Bay waterfront'],
    nearbyAreaSlugs: ['appliance-repair-in-sayreville-nj', 'appliance-repair-in-south-amboy-nj', 'appliance-repair-in-old-bridge-nj'],
  },
  ...
  'appliance-repair-in-port-monmouth-nj': {
    slug: 'appliance-repair-in-port-monmouth-nj',
    areaType: 'shore',
    intro: 'Port Monmouth is a Middletown Township bayfront section with cottages, year-round homes, and post-Sandy rebuilds. Many Port Monmouth kitchens sit on raised foundations now, and we have done enough installs here to understand the utility-chase routing that comes with elevated construction.',
    localNote: 'Post-Sandy raised homes sometimes have long refrigerator water-line runs; we insulate and freeze-protect those lines during winter service calls.',
    neighborhoods: ['Port Monmouth', 'Wilson Avenue', 'Bayview', 'Belford border'],
    landmarks: ['Port Monmouth Beach', 'Bayshore Waterfront Park', 'Henry Hudson Trail'],
    nearbyAreaSlugs: ['appliance-repair-belford-nj', 'appliance-repair-in-leonardo-nj', 'appliance-repair-in-keansburg-nj'],
  },
  ...
  'appliance-repair-in-sayreville-nj': {
    ...
    nearbyAreaSlugs: ['appliance-repair-in-parlin-nj', 'appliance-repair-in-south-amboy-nj', 'appliance-repair-in-old-bridge-nj'],
  },
  ...
  'appliance-repair-in-south-amboy-nj': {
    ...
    nearbyAreaSlugs: ['appliance-repair-in-perth-amboy-nj', 'appliance-repair-in-sayreville-nj', 'appliance-repair-in-parlin-nj'],
  },
  ...
  'appliance-repair-in-west-long-branch-nj': {
    slug: 'appliance-repair-in-west-long-branch-nj',
    areaType: 'suburban',
    intro: 'West Long Branch is a small borough built around Monmouth University with a mix of single-family homes, faculty households, and student rentals. Laundry-pair failure is our number-one call here — rental turnover means washers and dryers run at commercial duty cycles.',
    localNote: 'Landlord-owned rental properties in West Long Branch get scheduled service contracts from us to avoid emergency tenant-complaint calls.',
    neighborhoods: ['Monmouth University area', 'Cedar Avenue', 'Locust Avenue', 'West End'],
    landmarks: ['Monmouth University', 'Wilson Hall (Guggenheim Cottage)', 'Franklin Lake'],
    nearbyAreaSlugs: ['appliance-repair-in-ocean-nj', 'appliance-repair-in-oceanport-nj', 'appliance-repair-eatontown-nj'],
  },
