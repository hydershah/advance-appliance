...
Induction cooktops have become increasingly popular in luxury kitchens, and we have expertise in this advanced technology. We can diagnose and repair induction coil failures, control board issues, and cooling fan problems. For gas cooktops, we handle everything from simple igniter replacements to complex gas valve repairs, always prioritizing safety in every repair.`,
  ...
  },
  {
    ...
    slug: 'freezer-repair',
    icon: 'freezer',
    shortDescription: 'Professional freezer repair for chest, upright, built-in, and undercounter models.',
    description: 'The freezer is crucial for preserving fruit, meat, and other products, keeping them fresh long-term. When you notice soft ice cream or unusual sounds, our professional technicians diagnose and fix issues promptly.',
    longDescription: `Your freezer works around the clock to keep your food safely preserved at 0°F. When it malfunctions, you risk losing hundreds of dollars worth of frozen food in a matter of hours. At Advanced Appliance Repair Service, we understand the urgency of freezer repairs and provide fast, reliable service throughout Monmouth and Middlesex Counties in New Jersey.

We repair all types of freezers including chest freezers, upright freezers, built-in freezers, undercounter freezers, and mini freezers. Our factory-trained technicians specialize in premium brands like Sub-Zero, Viking, and Miele, as well as all major manufacturers. With over 30 years of experience, we have the expertise to diagnose and repair even the most complex freezer issues.

Modern freezers rely on precision temperature control, efficient compressors, and reliable defrost systems to maintain optimal food preservation. When any of these components fail, your stored food is at risk. Our technicians arrive with fully stocked service vehicles and fix 89% of breakdowns on-site using only genuine OEM manufacturer parts, backed by our 90-day warranty on parts and labor.`,
    features: [
      'Chest and upright freezer repair',
      'Built-in and undercounter models',
      'Compressor and sealed system service',
      'Defrost system repair',
      'Temperature control diagnostics',
      'Door seal and gasket replacement',
      'Evaporator fan motor service',
      'Sub-Zero and premium brand specialists',
    ],
    commonProblems: [
      { title: 'Frosting Up', description: 'A build-up of frost usually means a problem with the self-defrost system, including faulty defrost thermostats, timers, or damaged door gaskets.' },
      { title: 'Won\'t Start', description: 'A freezer that won\'t turn on requires inspection of the start relay, thermostat, and capacitor by a trained technician.' },
      { title: 'Too Cold', description: 'The ideal freezer temperature is 0°F. If your freezer runs continuously past this temperature, the thermostat or temperature control may be faulty.' },
      { title: 'Strange Noises', description: 'Unusual or loud noises usually indicate problems with the evaporator fan motor or blade, or issues with the compressor.' },
      { title: 'Won\'t Stop Running', description: 'A freezer that runs constantly may have issues with the temperature control thermostat, defrost timer, or condenser coils.' },
      { title: 'Too Warm', description: 'A freezer that isn\'t cold enough may have an open door seal, adjusted controls, failing door gaskets, or compressor issues.' },
    ],
    warningSigns: [
      'Ice cream is soft or melting',
      'Frost buildup on walls or food packages',
      'Freezer running constantly without cycling off',
      'Unusual buzzing, clicking, or grinding noises',
      'Water pooling under or around the freezer',
      'Food thawing or not staying frozen',
      'Ice buildup around the door seal',
      'Freezer is warmer than 0°F',
    ],
    repairProcess: [
      'Schedule your appointment online or by phone - same and next-day service available',
      'Our technician arrives with common freezer parts in stock',
      'We perform a complete diagnostic assessment for a $100 fee',
      'You receive a detailed estimate before any repair work begins',
      'We complete the repair using genuine OEM manufacturer parts',
      'We test the unit thoroughly to ensure proper temperature and operation',
      'Your repair is covered by our 90-day warranty on parts and labor',
    ],
    preventionTips: [
      'Keep the freezer at 0°F for optimal food preservation',
      'Don\'t overload the freezer - allow air circulation',
      'Check and clean door gaskets regularly for a tight seal',
      'Defrost manual-defrost freezers when ice exceeds 1/4 inch',
      'Clean condenser coils every 6-12 months',
      'Keep the freezer at least 3/4 full for best efficiency',
      'Avoid placing hot foods directly in the freezer',
      'Ensure adequate ventilation around the unit',
    ],
    faqs: [
      {
        question: 'Why is my freezer frosting up?',
        answer: 'Frost buildup is typically caused by a malfunctioning defrost system, including a faulty defrost thermostat, heater, or timer. Damaged door gaskets that allow warm, humid air to enter can also cause excessive frost. Our technicians can diagnose and repair the specific cause.',
      },
      {
        question: 'What types of freezers do you repair?',
        answer: 'We repair all types of freezers including chest freezers, upright freezers, built-in freezers, undercounter freezers, and mini freezers from all major brands including Sub-Zero, Viking, GE, Whirlpool, Frigidaire, and more.',
      },
      {
        question: 'My freezer is running but not cold enough. What\'s wrong?',
        answer: 'A freezer that runs but doesn\'t reach proper temperature may have a failing compressor, low refrigerant, dirty condenser coils, a faulty evaporator fan, or a defective thermostat. We diagnose and repair all of these issues.',
      },
      {
        question: 'How long should a freezer last?',
        answer: 'Most freezers last 12-20 years depending on the type and brand. Chest freezers tend to last longer than upright models. If your freezer is under 12 years old and the repair cost is reasonable, repair is usually more economical than replacement.',
      },
      {
        question: 'Is it worth repairing an old freezer?',
        answer: 'If the repair cost is less than half the price of a new freezer and the unit is under 15 years old, repair is generally the better choice. We provide honest assessments and will advise you if replacement makes more sense.',
      },
      {
        question: 'How quickly can you repair my freezer?',
        answer: 'We offer same and next-day service. Most freezer repairs are completed in a single visit since our technicians carry common parts on their service vehicles. For complex issues or specialty parts, we provide accurate timelines.',
      },
    ],
  ...
  },
  {
    ...
    slug: 'range-repair',
    icon: 'range',
    shortDescription: 'Expert range repair for gas, electric, dual fuel, and professional-grade models.',
    description: 'Cooktops and ranges are essential for cooking enthusiasts. When these appliances malfunction, they significantly impact meal quality. We provide reliable range repair with quick diagnostics and proper repairs.',
    longDescription: `Your range is the heart of your kitchen, combining cooktop and oven functionality in one essential appliance. When it malfunctions, your entire cooking routine is disrupted. Advanced Appliance Repair Service provides expert range repair throughout Monmouth and Middlesex Counties, with specialized knowledge of both domestic and foreign brands.

We service all types of ranges including electric, gas, dual fuel, freestanding, slide-in, and drop-in models. Each type presents unique repair challenges, from gas ignition systems to electric heating elements and electronic control boards. Our factory-trained technicians are certified to work on professional-grade ranges from Viking, Wolf, Thermador, and other luxury manufacturers.

Whether you have a basic gas range or a high-end dual fuel model with convection, our technicians have the training and genuine OEM parts to restore it to peak performance. We fix 89% of breakdowns on-site during the first visit. Safety is always our top priority, especially with gas ranges where proper repair is critical for your family\'s safety.`,
    features: [
      ...
      'Electronic control board repair',
      'Temperature calibration',
      'Viking, Wolf, Thermador certified',
    ],
    commonProblems: [
      { title: 'Inconsistent Temperature', description: 'Oven temperature fluctuations make cooking unreliable and can result from faulty temperature sensors, heating elements, or calibration issues.' },
      { title: 'Non-Functional Elements', description: 'When one heating element or burner fails to work, it may indicate wiring issues, faulty switches, or element burnout requiring professional repair.' },
      { title: 'Excessive Heat', description: 'A range that runs too hot prevents proper execution of low-temperature cooking and may indicate thermostat or control board failure.' },
      { title: 'Improper Cooking Results', description: 'Uneven or poor cooking results typically point to heating element issues, convection fan problems, or temperature sensor malfunctions.' },
      { title: 'Broken Timer', description: 'A non-functional timer disrupts cooking precision and may indicate control board issues requiring professional diagnosis.' },
      { title: 'Won\'t Start', description: 'A range that won\'t turn on may have electrical problems, faulty igniters, gas valve issues, or control board failures.' },
    ],
    warningSigns: [
      'Oven not reaching set temperature',
      'Gas burners won\'t light or light slowly',
      'Uneven cooking or hot spots',
      'Strange smells during operation',
      'Error codes on the display',
      'Clicking sounds without ignition',
      'Oven door not closing properly',
      'Timer or controls not responding',
    ],
    repairProcess: [
      'Contact us by phone or schedule online for prompt service',
      'Our certified technician arrives with specialized range repair tools',
      'We perform thorough diagnostics and safety checks',
      'You receive a detailed estimate before any work begins',
      'Repairs are completed using genuine OEM manufacturer parts',
      'We test all burners, oven functions, and controls',
      'Your repair is covered by our 90-day warranty on parts and labor',
    ],
    preventionTips: [
      'Clean burner ports and grates regularly',
      'Wipe up spills promptly to prevent buildup',
      'Don\'t line the oven bottom with aluminum foil',
      'Check and replace worn door gaskets',
      'Have gas connections inspected annually',
      'Use the self-cleaning feature sparingly',
      'Keep ventilation hood filters clean',
      'Schedule professional maintenance every 2-3 years',
    ],
    faqs: [
      {
        question: 'What types of ranges do you repair?',
        answer: 'We repair all types of ranges including electric, gas, dual fuel, freestanding, slide-in, and drop-in models from all major brands. We specialize in premium brands like Viking, Wolf, and Thermador.',
      },
      {
        question: 'My range oven is not heating evenly. Can you fix it?',
        answer: 'Yes, uneven heating is commonly caused by a faulty heating element, failed temperature sensor, malfunctioning convection fan, or calibration issues. We diagnose the specific cause and make the necessary repairs.',
      },
      {
        question: 'Why won\'t my gas range ignite?',
        answer: 'Gas ignition problems are typically caused by worn igniters, clogged burner ports, faulty spark modules, or gas valve issues. Our technicians safely diagnose and repair all gas ignition systems.',
      },
      {
        question: 'Do you repair dual fuel ranges?',
        answer: 'Yes, we specialize in dual fuel ranges which combine gas cooktops with electric ovens. These require expertise in both gas and electric systems, and our technicians are trained on all major dual fuel models.',
      },
      {
        question: 'How much does range repair cost?',
        answer: 'Our diagnostic fee is $100, which is applied to the repair cost if you proceed. Total costs depend on the issue and parts needed. We provide a complete estimate before starting any work.',
      },
      {
        question: 'Is it safe to use a range with a broken burner?',
        answer: 'While you may be able to use other burners, we recommend having any malfunctioning component inspected promptly. For gas ranges especially, faulty components can pose safety risks and should be repaired by a professional.',
      },
    ],
  ...
  },
  {
    ...
    slug: 'stove-repair',
    icon: 'stove',
    shortDescription: 'Reliable stove repair for all gas and electric models from top brands.',
    description: 'Whether your stove burner won\'t light, the oven won\'t heat, or the controls aren\'t responding, our experienced technicians provide fast, professional stove repair service.',
    longDescription: `A malfunctioning stove can bring your kitchen to a standstill. Whether you rely on a gas stove for precise flame control or an electric model for consistent heating, having a fully working stove is essential for daily meal preparation. Advanced Appliance Repair Service provides expert stove repair throughout Monmouth and Middlesex Counties.

Our factory-trained technicians service all stove types and brands, from basic residential models to high-end professional-style units. We understand the differences between gas and electric stove systems and carry the specialized tools and genuine OEM parts needed to repair both safely and effectively. With over 30 years of experience, we have seen every type of stove problem and know how to fix it right the first time.

Stove problems should never be ignored, especially with gas models where faulty components can create safety hazards. Our technicians prioritize safety in every repair, ensuring gas connections are secure, electrical components are properly wired, and all systems function according to manufacturer specifications. We fix 89% of breakdowns on-site, backed by our 90-day warranty on parts and labor.`,
    features: [
      'Gas and electric stove repair',
      'Burner and element replacement',
      'Igniter and spark module service',
      'Thermostat and temperature repair',
      'Control knob and switch replacement',
      'Gas valve and safety inspection',
      'Electronic control board repair',
      'All major brands serviced',
    ],
    commonProblems: [
      { title: 'Burner Won\'t Light', description: 'Gas burners that won\'t ignite typically have clogged ports, worn igniters, faulty spark modules, or gas supply issues.' },
      { title: 'Uneven Heating', description: 'Hot spots or uneven cooking results from damaged heating elements, warped burner caps, or incorrect gas pressure adjustments.' },
      { title: 'Electric Element Not Working', description: 'A non-heating electric element is usually caused by a burned-out coil, faulty infinite switch, or wiring connection problems.' },
      { title: 'Gas Smell', description: 'If you smell gas when the stove is off, turn off the gas supply immediately and call for professional service. This may indicate a leaking gas valve or connection.' },
      { title: 'Control Knobs Not Working', description: 'Broken or stuck control knobs may indicate worn valve stems, cracked knob shafts, or faulty infinite switches.' },
      { title: 'Stove Won\'t Turn On', description: 'A stove that won\'t start may have electrical supply issues, blown fuses, faulty igniters, or control board failures.' },
    ],
    warningSigns: [
      'Gas smell when stove is off',
      'Burners won\'t light or light slowly',
      'Yellow or uneven gas flames',
      'Electric elements not heating fully',
      'Clicking sounds without ignition',
      'Control knobs are loose or unresponsive',
      'Sparking or arcing from electric elements',
      'Stove making unusual noises during use',
    ],
    repairProcess: [
      'Schedule your appointment online or by phone',
      'Our technician arrives with common stove parts in stock',
      'We perform complete diagnostics including gas safety checks',
      'You receive an honest estimate before repairs begin',
      'Repairs are made with genuine OEM manufacturer parts',
      'We test all burners, elements, and controls',
      'All work is backed by our 90-day warranty on parts and labor',
    ],
    preventionTips: [
      'Keep burner ports clean and free of food debris',
      'Clean spills promptly to prevent buildup and damage',
      'Use properly sized cookware for each burner',
      'Don\'t use the stove for heating your kitchen',
      'Check gas connections periodically for leaks',
      'Replace worn or cracked control knobs promptly',
      'Keep the area around the stove clear of flammable items',
      'Schedule professional maintenance and inspection regularly',
    ],
    faqs: [
      {
        question: 'My gas stove burner won\'t light. What should I do?',
        answer: 'First, check if other burners work. If only one burner is affected, it likely has a clogged port or faulty igniter. Clean the burner cap and ports. If that doesn\'t work, the igniter or spark module may need professional replacement.',
      },
      {
        question: 'Why is my gas flame yellow instead of blue?',
        answer: 'Yellow flames indicate incomplete combustion, usually caused by clogged burner ports, incorrect air-to-gas mixture, or low gas pressure. Blue flames with small yellow tips are normal, but entirely yellow flames should be professionally inspected.',
      },
      {
        question: 'Is it dangerous to use a stove with one broken burner?',
        answer: 'For electric stoves, using other burners is generally safe. For gas stoves, any malfunction should be inspected promptly as it could indicate gas flow issues. If you smell gas at any time, stop using the stove and call for service.',
      },
      {
        question: 'Do you repair both gas and electric stoves?',
        answer: 'Yes, we repair all gas and electric stove models from every major manufacturer. Our technicians are trained on both gas and electric systems and carry the parts and tools needed for both types.',
      },
      {
        question: 'How much does stove repair cost?',
        answer: 'Our diagnostic fee is $100, which is applied to the repair cost if you proceed. Total repair costs depend on the specific issue and parts required. We always provide a complete estimate before beginning any work.',
      },
      {
        question: 'Can you repair a stove with a cracked glass top?',
        answer: 'Yes, we can replace cracked glass cooktop surfaces for most major brands. We recommend replacement even for small cracks, as they can worsen over time and present safety concerns.',
      },
    ],
