        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
          <div className="lg:col-span-1">
            ...
            <div className="flex space-x-4">
              <a href={businessInfo.socialMedia.facebook} target="_blank" rel="noopener noreferrer nofollow" className="w-10 h-10 border border-gray-700 flex items-center justify-center text-gray-400 hover:text-[#D4AF37] hover:border-[#D4AF37] transition-colors" aria-label="Facebook">
              ...
              <a href={businessInfo.socialMedia.twitter} target="_blank" rel="noopener noreferrer nofollow" className="w-10 h-10 border border-gray-700 flex items-center justify-center text-gray-400 hover:text-[#D4AF37] hover:border-[#D4AF37] transition-colors" aria-label="Twitter">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24"><path d="M23.953 4.57a10 10 0 01-2.825.775 4.958 4.958 0 002.163-2.723c-.951.555-2.005.959-3.127 1.184a4.92 4.92 0 00-8.384 4.482C7.69 8.095 4.067 6.13 1.64 3.162a4.822 4.822 0 00-.666 2.475c0 1.71.87 3.213 2.188 4.096a4.904 4.904 0 01-2.228-.616v.06a4.923 4.923 0 003.946 4.827 4.996 4.996 0 01-2.212.085 4.936 4.936 0 004.604 3.417 9.867 9.867 0 01-6.102 2.105c-.39 0-.779-.023-1.17-.067a13.995 13.995 0 007.557 2.209c9.053 0 13.998-7.496 13.998-13.985 0-.21 0-.42-.015-.63A9.935 9.935 0 0024 4.59z"/></svg>
              </a>
              <a href={businessInfo.socialMedia.instagram} target="_blank" rel="noopener noreferrer nofollow" className="w-10 h-10 border border-gray-700 flex items-center justify-center text-gray-400 hover:text-[#D4AF37] hover:border-[#D4AF37] transition-colors" aria-label="Instagram">
              ...
              <a href={businessInfo.socialMedia.youtube} target="_blank" rel="noopener noreferrer nofollow" className="w-10 h-10 border border-gray-700 flex items-center justify-center text-gray-400 hover:text-[#D4AF37] hover:border-[#D4AF37] transition-colors" aria-label="YouTube">
          ...
          <div>
            ...
            <ul className="space-y-3">
              {services.slice(0, 6).map((service) => (
                <li key={service.id}><Link href={`/services/${service.slug}`} className="text-gray-400 text-sm hover:text-white transition-colors">{service.name}</Link></li>
              ))}
              <li><Link href="/services" className="text-[#D4AF37] text-sm hover:text-white transition-colors">View All Services</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              {[...serviceAreas].sort((a, b) => a.name.localeCompare(b.name)).slice(0, 8).map((area) => (
                <li key={area.id}><Link href={`/areas/${area.slug}`} className="text-gray-400 text-sm hover:text-white transition-colors">{area.name}</Link></li>
              ))}
              <li><Link href="/our-service-area" className="text-[#D4AF37] text-sm hover:text-white transition-colors">View All Areas</Link></li>
            </ul>
          </div>
        ...
        <div className="container mx-auto px-6 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center text-sm text-gray-500">
            ...
            <div className="flex flex-wrap justify-center gap-x-6 gap-y-2 mt-4 md:mt-0">
              <Link href="/our-brands" className="hover:text-white transition-colors">Our Brands</Link>
              <Link href="/our-reviews" className="hover:text-white transition-colors">Our Reviews</Link>
              <Link href="/our-service-area" className="hover:text-white transition-colors">Our Service Area</Link>
              <Link href="/privacy-policy" className="hover:text-white transition-colors">Privacy Policy</Link>
              <Link href="/terms-of-service" className="hover:text-white transition-colors">Terms of Service</Link>
              <Link href="/sms-messaging-compliance" className="hover:text-white transition-colors">SMS / Messaging Compliance</Link>
            </div>
          </div>
        </div>
      </div>
