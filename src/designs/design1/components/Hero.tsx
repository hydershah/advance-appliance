          ...
          <div className={`flex flex-col ${alignClasses[align]} max-w-3xl ${align === 'center' ? 'mx-auto' : ''}`}>
            ...
            {showCTA && (
              <div className={`flex flex-col sm:flex-row gap-4 ${align === 'center' ? 'justify-center' : ''}`}>
                ...
                <Link href="/contact" className="inline-flex items-center justify-center px-8 py-4 border border-white text-white text-sm uppercase tracking-wider hover:bg-white hover:text-black transition-all duration-300">
                  Schedule Service
