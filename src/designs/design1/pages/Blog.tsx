...
const Blog: React.FC = () => {
  ...
  return (
    <>
      ...
      <Header />
      <main>
        <Hero title="Expert Insights" subtitle="Our Blog" description="Tips, guides, and industry insights from our team of luxury appliance experts." image={images.kitchen} showCTA={false} overlay="gradient" height="small" align="center" />
