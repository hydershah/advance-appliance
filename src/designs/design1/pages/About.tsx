            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              <div>
                ...
                <div className="space-y-6 mt-8">
                  ...
                  <p className="text-gray-600 leading-relaxed">Customers choose us because we offer reliable next-day in-home service, factory-certified repairs, and work that is fully warranted for your peace of mind.</p>
